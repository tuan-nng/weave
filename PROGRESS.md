...
- **Latest commit:** TBD (feat-027: Default Board Template)
- **Active feature:** none — feat-027 just shipped
- **Build status:** green — `cargo build -p weave-server` succeeds; `bun run build` in web/ succeeds
- **Test status:** green — 397 Rust tests + 76 frontend tests pass (+2 new: test_default_board_template, test_default_board_specialists_load_from_disk)
...
(none — feat-027 complete; ready for next feature)
